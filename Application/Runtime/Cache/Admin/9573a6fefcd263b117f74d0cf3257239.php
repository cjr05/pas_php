...
<script src="/pas_php/Public/Admin/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(/pas_php/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <form action="" method="POST">
        ...
        <li class="yzm">
        <span><input width="150" name="verify" type="text" maxlength="4" value="验证码" onclick="JavaScript:this.value=''"/></span><cite><img src="/pas_php/index.php/Admin/Manager/verifyImg" onclick="this.src='/pas_php/index.php/Admin/Manager/verifyImg/'+Math.random()" alt=""></cite> 
        </li>
